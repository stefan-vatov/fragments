...
Install the plugin in `<vault>/.obsidian/plugins/fragments`, enable it under Community plugins, and run **Fragments: Open** or click the ribbon icon. The default library folder is `Fragments`; change it in the app's Settings. Subfolders become collections. Settings also lets you choose the font used in snippet editing and preview, including a custom installed font.
